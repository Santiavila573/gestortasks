...
<body>
    <div class="container">
        <h1> <?= htmlspecialchars($sprint_nombre) ?></h1>
        <?php if (empty($tareas)): ?>
...
<head>
    ...
    .crear-tarea input, .crear-tarea select, .crear-tarea button, .boton-crear boton-volver  {
        padding: 10px;
        border: 1px solid #ecf0f1;
        border-radius: 6px;
        font-size: 0.95rem;
...
<body>
    <div class="container">
        ...
        <?php if ($_SESSION['rol'] === 'Scrum Master'): ?>
            <div class="crear-tarea">
                <form method="POST">
                    ...
                    <button type="submit" name="crear_tarea" class="boton-crear boton-volver">Crear Tarea</button>
                </form>
            </div>
        <?php endif; ?>
        ...
        <div class="acciones">
            <a href="http://localhost:3000/app/controllers/logic/sprints.php" class="boton-volver">Volver a Sprints</a>
        </div>
    </div>
</body>
</html>