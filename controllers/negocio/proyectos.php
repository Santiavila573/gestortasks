        ...
        <div class="content-wrapper">
            ...
            <div class="chatbot-panel" id="chatbot-panel">
                <div class="chatbot-messages" id="chatbot-messages">
                    ...
                    <p><strong>Chatbot:</strong> ¡Hola! Soy tu asistente ScrumBot de GestorTasks. <i class="fas fa-robot" id="robot-icon"></i><br /> Escribe "Sprints o Tareas" para ver tus sprints y tareas pendientes.</p>
    ...
    <script>
        ...
        function showSprintFeedback() {
            const feedbackMessages = [
                "He revisado tus sprints, Escribe 'Sprints' para ver el estado de tus sprints nuevamente o 'Tareas' para ver tus tareas.",
            ];
